    ...
    return(
        <div>
            ...
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
                <img src={passwordicon} alt="reset password" className="w-20 h-20 mx-auto mb-4"></img>
                <h1 className="text-2xl font-md text-indigo-600 mb-2">Create a new password</h1>
                <p className="text-sm text-gray-500">Create a password with at least 6 letters and numbers.  you'll
                    <br />
