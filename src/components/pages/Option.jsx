  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-2xl m-auto p-6 px-4 sm:px-6 bg-white rounded-xl shadow-lg mt-6">
        ...
        <div>
          <h3 className="text-xs px-3 font-semibold text-gray-700 mb-1 mt-5">
            Color Options
          </h3>
          <div className="grid grid-cols-2 gap-5">
            <div
        ...
        <div className="flex items-center justify-between mt-6 bg-white p-3 rounded-2xl shadow-md">
          ...
          <select className="border border-gray-300 bg-gray-50 text-gray-700 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200">
        ...
        <div className="flex justify-between mt-6">
          ...
          <button
            ...
            disabled={!selectedSide || !colorOption || !paperSize}
